...
const TrashWindow = ({ isOpen, origin, onClose, onClosed }: TrashWindowProps) => {
    ...
    return (
        <div
            className={`contact-shell trash-shell${isOpen ? " is-open" : " is-closing"}`}
            ref={shellRef}
            ...
            <section className="contact-window trash-window" ref={trashRef}>
                <div className="contact-header trash-header" onPointerDown={handleWindowPointerDown}>
                    <div className="traffic-lights" aria-hidden="true">
                        <button type="button" className="traffic red" onClick={onClose} aria-label="Close trash" />
                        ...
                        {trashItems.map((item) => {
                            ...
                            return (
                                <div key={item.id} className="trash-item trash-window-item">
                                    ...
                                    <button type="button" className="trash-item-action" aria-label={`Restore ${item.name}`}>
                                        <RotateCcw size={16} />
                                    </button>
                                </div>
                            );
